	...
	.Config =
		{
			...
			//.MaxPowerConsumption    = USB_CONFIG_POWER_MA(500) // original
			.MaxPowerConsumption    = USB_CONFIG_POWER_MA(0) // same as a hub, the Switch allows greater current draw with this (may be patched out later)
		},
